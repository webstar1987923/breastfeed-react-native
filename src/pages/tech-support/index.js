...
class TechSupportScreen extends React.Component {
	...
	componentDidUpdate(prevProps) {
		...
		if(prevProps.contactForm.isTechFormSuccessful === false && contactForm.isTechFormSuccessful === true) {
			this.setState(() => {
	...
	render() {
		...
		return (
			<View style={styles.container}>
				<Text style={styles.supportdTitle}>Tech Support</Text>
				<ScrollView>
					<Text style={styles.contactText}>
						If you’re having an issue with your mobile application, please don’t hesitate to contact us.
						{"\n"}
						{"\n"}
						Our Technical Support Team is here to support you. Complete the form below and we will contact you.
					</Text>
...
const mapDispatchToProps = {
	dispatchTechSupportContactForm: (data) => contactFormActions.handleTechForm(data)
};
