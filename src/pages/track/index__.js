...
class TrackScreen extends React.Component {
	...
	componentDidMount() {
		// this.props.dispatchSetTrackActiveTab(this.state.selectedTab);
	}

	componentDidUpdate(prevProps) {
		// const { navigation } = this.props;
		// console.log("navifation called>>>");
	...
	render() {
		...
		console.log({selectedTab, activeIndex});
		console.log("Casdadas>>")
				...
				<View style={{ flex: 1, flexGrow: 1, marginTop: 10 }}>
					...
					>
						...
						<TabFirstComponent
							...
							activeTabStyle={styles.activeTabStyle}
							activeTextStyle={styles.activeTextStyle}
							child={<PumpCards navigation={navigation} currentDate={currentDate} onTabChange={(tab, lengthValue) => {
								console.log("CLICK ON PUMP");
							}} />}
						/>
						<TabFirstComponent
							heading="Bottles"
							...
							activeTabStyle={styles.activeTabStyle}
							activeTextStyle={styles.activeTextStyle}
							child={<BottlesCards navigation={navigation} currentDate={currentDate} onTabChange={(tab, lengthValue) => {}} />}
						/>
						<TabFirstComponent
							heading="Diapers"
							tabStyle={styles.tabStyle}
